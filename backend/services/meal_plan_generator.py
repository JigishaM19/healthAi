...
INDIAN_MEALS = {
    "vegetarian": {
        ...
        "snack_morning": [
            ...
            "1 Pear + 5 Almonds (100 kcal)",
            "1 Cup Greek Yogurt / Curd with berries (110 kcal)",
            "1 Orange + Pumpkin Seeds (95 kcal)"
        ],
        "lunch": [
        ...
        "snack_evening": [
            ...
            "Lemon Tea + Roasted Flaxseeds (85 kcal)",
            "Vegetable Soup + 4 Almonds (95 kcal)",
            "Mint Tea + Roasted Soybeans (110 kcal)"
        ],
        "dinner": [
    ...
    "non_vegetarian": {
        "breakfast": [
            ...
            "Besan Chilla with Egg stuffing + Mint Chutney (290 kcal | 17g Protein)",
            "3 Egg White Omelette with Mushrooms & Peppers (210 kcal | 20g Protein)",
            "Boiled Eggs (2) + Oats Porridge (310 kcal | 19g Protein)",
            "Chicken Keema Paratha (1) with Curd (340 kcal | 24g Protein)"
        ],
        "snack_morning": [
            "1 Apple or Guava + 4 Walnuts (120 kcal)",
            "1 Bowl Papaya / Pomegranate (90 kcal)",
            ...
            "Roasted Chana (1 small bowl) (110 kcal)",
            "1 Pear + 5 Almonds (100 kcal)",
            "1 Cup Greek Yogurt / Curd (110 kcal)",
            "1 Orange + Pumpkin Seeds (95 kcal)"
        ],
        "lunch": [
            ...
            "1 Bowl Brown Rice + Chicken Tikka Curry + Salad (440 kcal | 36g Protein)",
            "2 Jowar Roti + Steamed Fish in Mustard Sauce + Salad (390 kcal | 30g Protein)",
            "2 Roti + Egg Curry (2 eggs) + Palak Dal (380 kcal | 22g Protein)",
            "1 Bowl Vegetable Khichdi + Grilled Chicken Strips (400 kcal | 32g Protein)"
        ],
        "snack_evening": [
            "Green Tea + 1 Handful Roasted Makhana (100 kcal)",
            "1 Glass Coconut Water + 5 Almonds (90 kcal)",
            "Sprouts Bhel with pomegranate & lemon (120 kcal)",
            "Boiled Kala Chana chaat with coriander & cucumber (130 kcal)",
            "Lemon Tea + 2 Boiled Egg Whites (90 kcal)",
            "Chicken Clear Soup (100 kcal)",
            "Mint Tea + Roasted Makhana (95 kcal)"
        ],
        "dinner": [
            ...
            "Grilled Salmon / Fish Fillet + Steamed Asparagus & Carrots (310 kcal | 28g Protein)",
            "1 Bowl Chicken & Vegetable Soup + 1 Multigrain Roti (290 kcal | 26g Protein)",
            "Stir-fried Tofu & Egg White Scramble + Salad (270 kcal | 24g Protein)",
            "1 Roti + Fish Sukka + Cucumber Tomato Salad (300 kcal | 27g Protein)"
        ]
    }
}
...
def generate_7day_meal_plan(diet_preference: str = "vegetarian", target_calories: int = 1600) -> List[Dict[str, Any]]:
    pref = "non_vegetarian" if any(k in (diet_preference or "").lower() for k in ["non", "chicken", "egg", "fish", "meat"]) else "vegetarian"
